...
// adminlterun = function(){
    $(function () {
        ...
        //初始化参数  - pushMenu(), 调用内部Plugin构造函数，初始化合并options，并增加data属性lte.pushmenu，该属性值为PushMenu对象，对象初始化参数为合并options
        $('[data-toggle="push-menu"]').pushMenu()
        $('body').layout()
        //通上lte.pushmeu获取PushMenu对象，通过绑定在[data-toggle="push-menu"]元素上的data属性，获取PushMenu (使用options初始化)
